...
import QuantidadeProdutosConsumidos from "../negocio/QuantidadeProdutosConsumidos";
...
while (execucao) {
    ...
    switch (opcao) {
        ...
        case 16:
            ...
            let cadastrarPet = new CadastroPetCliente(clientePet)
        ...
        case 22:
            ...
            break;
        case 23:
            const listarProdutosConsumidosOrdenado = new QuantidadeProdutosConsumidos(empresa)
            listarProdutosConsumidosOrdenado.listar()
            break;
        case 0:
            execucao = false
