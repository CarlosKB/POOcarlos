...
export default function ClienteFormCadastro() {
  ...
  const [values, setValues] = useState<FormValues>({ nome: "", nomesocial: "", cpf: "", cpfdataemissao: "", rg: "", rgdataemissao: "", datacadastro: "", petnome: "", petraca: "", pettipo: "", petgenero: "", telefoneddd: "", telefonenumero: ""});
  ...
  const limparCampos = () => {
    setValues({ nome: "", nomesocial: "", cpf: "", cpfdataemissao: "", rg: "", rgdataemissao: "", datacadastro: "", petnome: "", petraca: "", pettipo: "", petgenero: "", telefoneddd: "", telefonenumero: ""});
  };
  ...
  const handleClickButton = async () => {
    const response = await axios.post("http://localhost:3001/cadastroCliente", {
        ...
        ClienteRG: values.rg,
        ClienteRGDataEmissao: values.rgdataemissao,
