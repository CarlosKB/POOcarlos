...
function cadastroCliente(ClienteNomeSocial, ClienteNome, ClienteCPF, ClienteCPFDataEmissao, ClienteRG, ClienteRGDataEmissao, ClienteDataCadastro, callback) {
    let SQL = "INSERT INTO cliente (ClienteNomeSocial, ClienteNome, ClienteCPF, ClienteCPFDataEmissao, ClienteRG, ClienteRGDataEmissao, ClientedataCadastro) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING ClienteID";
    cliente.query(SQL, [ClienteNomeSocial, ClienteNome, ClienteCPF, ClienteCPFDataEmissao, ClienteRG, ClienteRGDataEmissao, ClienteDataCadastro], (err, result) => {
        if (err) {
            console.log(err);
            callback(err);
        } else {
...
app.post('/cadastroCliente', (req, res) => {
    const { ClienteNomeSocial, ClienteNome, ClienteCPF, ClienteCPFDataEmissao, ClienteRG, ClienteRGDataEmissao, ClienteDataCadastro } = req.body;

    cadastroCliente(ClienteNomeSocial, ClienteNome, ClienteCPF, ClienteCPFDataEmissao, ClienteRG, ClienteRGDataEmissao, ClienteDataCadastro, (err, clienteID) => {
        if (err) {
